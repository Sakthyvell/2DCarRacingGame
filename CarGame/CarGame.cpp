...
void startGame(){
    ...
    glColor3f(0.000, 0.00, 0.00);

    glVertex2f(lrIndex+28,10);
    glVertex2f(lrIndex+30,8);
    glVertex2f(lrIndex+30,1);
    glVertex2f(lrIndex+28,-2);
    glEnd();
...
void fristDesign(){
      ...
      glColor3f(0.133, 0.545, 0.133);
        ...
        glColor3f(1.000, 1.000, 0.000);
        renderBitmapString(30,80,(void *)font1,"Assignment Racing Game ");
        ...
        renderBitmapString(30-5,50-43,(void *)font3,"Sakthyvell Superamaniam");
